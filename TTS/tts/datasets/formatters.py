...
def raw_formatter(root_path, manifest_file, wavs_path='wavs', **kwargs):  # pylint: disable=unused-argument
...
def preprocessed_formatter(root_path, manifest_file, wavs_path='wavs_trimmed_normalized', **kwargs):  # pylint: disable=unused-argument
    """Assumes each line as ```<filename>|<transcription>```
    """
    txt_file = os.path.join(root_path, manifest_file)
    items = []
...
def denoised_formatter(root_path, manifest_file, wavs_path='wavs_denoised_trimmed_normalized', **kwargs):  # pylint: disable=unused-argument
    """Assumes each line as ```<filename>|<transcription>```
    """
    txt_file = os.path.join(root_path, manifest_file)
    items = []
