...
from TTS.tts.utils.text.luganda.phonemizer import luganda_text_to_phonemes
from TTS.tts.utils.text.phonemizers.base import BasePhonemizer

_DEF_LG_PUNCS = "' "


class LG_Phonemizer(BasePhonemizer):
    ...
    def phonemize_lg(text: str, separator: str = "|") -> str:
        ph = luganda_text_to_phonemes(text, separator)
        return ph
