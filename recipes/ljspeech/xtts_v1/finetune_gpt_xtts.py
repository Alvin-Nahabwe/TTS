...
SPEAKER_REFERENCE = (
    "/home/ubuntu/tts/data/wavs/common_voice_lg_28138292.wav"  # speaker reference to be used in training test sentences
)
...
def main():
    ...
    audio_config = XttsAudioConfig(
        sample_rate=16000, dvae_sample_rate=16000, diffusion_sample_rate=24000, output_sample_rate=24000
    )
    ...
    config = GPTTrainerConfig(
        ...
        test_sentences=[
            ...
            {
                "text": "bwe muba mulima mukozesa nkumbi ki",
                "speaker_wav": SPEAKER_REFERENCE,
                "language": LANGUAGE,
            },
        ],
